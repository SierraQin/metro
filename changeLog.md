...
## 当前版本 2.0.1
### [通过腾讯云直接下载PDF文件(方便快捷无广告)](https://metro-1252278458.cos.ap-beijing.myqcloud.com/MTR/MTR2.0.1.pdf)

### [通过Gitee直接下载PDF文件(可能需要登录)](https://gitee.com/SierraQin/metro/raw/master/MTR2.0.1.pdf)
...
# 更新日志
##### 06-Jan-21 正式版2.0.1
- 修改回龙观车辆段(感谢[snally2006](http://www.ditiezu.com/space-uid-745758.html))的错误
- 为易混淆上下行的线路添加了上下行标注(亦庄线、首都机场线)
- 优化了亦庄T1线预留道岔的表示方式
- 采纳读者[漱子衿](http://www.ditiezu.com/space-uid-87012.html)的建议，回退了2.0.0对某些信息标注形式的更改
- 宋家庄停车场标注排版微调
